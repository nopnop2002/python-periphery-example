...
if __name__ == '__main__':
	...
	parser.add_argument('--data', type=int, help="DATA GPIO", default=18)
	parser.add_argument('--latch', type=int, help="LATCH GPIO", default=15)
	parser.add_argument('--shift', type=int, help="SHIFT GPIO", default=14)
	...
	lcd = hdd44780(args.data, args.latch, args.shift)
